...
class TextDocumentTest(unittest.TestCase):
    ...
    def test_that_it_builds_from_a_word_document(self):
        doc_name = "my document"
        paragraphs = ["[AP]: this is what was said _00:00:05_ and then this _00:01:23_"]
        docx_doc = Document()
    ...
    def test_that_it_handles_multiple_paragraphs(self):
        ...
        self.assert_correct_label(
            labels[3],
            "And this one starts the next line ",
            five_minutes_three_seconds_in_ms,
            five_minutes_fifty_five_seconds_in_ms,
        )
